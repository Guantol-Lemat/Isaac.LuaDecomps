...
local Actor_SlotMachine = require("Isaac.Content.Actor.Slot.SlotMachine")
local Actor_BloodDonationMachine = require("Isaac.Content.Actor.Slot.BloodDonationMachine")
local Actor_FortuneTellingMachine = require("Isaac.Content.Actor.Slot.FortuneTellingMachine")
local Actor_Beggar = require("Isaac.Content.Actor.Slot.Beggar")
local Actor_DevilBeggar = require("Isaac.Content.Actor.Slot.DevilBeggar")
local Actor_ShellGame = require("Isaac.Content.Actor.Slot.ShellGame")
local Actor_KeyMaster = require("Isaac.Content.Actor.Slot.KeyMaster")
local Actor_DonationMachine = require("Isaac.Content.Actor.Slot.DonationMachine")
local Actor_BombBum = require("Isaac.Content.Actor.Slot.BombBum")
local Actor_ShopRestockMachine = require("Isaac.Content.Actor.Slot.ShopRestockMachine")
local Actor_GreedDonationMachine = require("Isaac.Content.Actor.Slot.GreedDonationMachine")
local Actor_MomsDressingTable = require("Isaac.Content.Actor.Slot.MomsDressingTable")
local Actor_BatteryBum = require("Isaac.Content.Actor.Slot.BatteryBum")
local Actor_HomeClosetPlayer = require("Isaac.Content.Actor.Slot.HomeClosetPlayer")
local Actor_CraneGame = require("Isaac.Content.Actor.Slot.CraneGame")
local Actor_Confessional = require("Isaac.Content.Actor.Slot.Confessional")
local Actor_RottenBeggar = require("Isaac.Content.Actor.Slot.RottenBeggar")
